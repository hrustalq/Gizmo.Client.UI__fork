...
namespace System.ComponentModel
{
        ...
        INotifyPropertyChanged
    {
        ...
        {
            RaisePropertyChanged(new PropertyChangedEventArgsExtended());
        }
        ...
        protected void RaisePropertyChanged(string propertyName)
        {
            ...
            RaisePropertyChanged(this, new PropertyChangedEventArgsExtended(propertyName));
        }
        ...
        protected void RaisePropertyChanged(PropertyChangedEventArgsExtended args)
        {
            //Null or empty string propertyName should be allowed http://msdn.microsoft.com/en-us/library/system.componentmodel.inotifypropertychanged.propertychanged.aspx
        ...
        protected void RaisePropertyChanged(object sender, PropertyChangedEventArgsExtended args)
        {
            if (sender == null)
        ...
        /// <param name="sender">Event sender.</param>
        /// <param name="args">Event arguments.</param>
        protected virtual bool OnPropertyChanging(object sender, PropertyChangedEventArgsExtended args)
        {
            return true;
        }
        ...
        /// <param name="sender">Event sender.</param>
        /// <param name="args">Event arguments.</param>
        protected virtual void OnPropertyChanged(object sender, PropertyChangedEventArgsExtended args)
        { }
        ...
        protected bool SetProperty<T>(ref T field, T value, [CallerMemberName] string propertyName = null)
        {
            ...
            var args = new PropertyChangedEventArgsExtended(propertyName, value, oldValue);
        ...
        protected bool IsIgnoredProperty(object owner, string propertyName)
        {
            ...
            return property.GetCustomAttribute<PropertyChangeIgnoreAttribute>() != null;
        }
